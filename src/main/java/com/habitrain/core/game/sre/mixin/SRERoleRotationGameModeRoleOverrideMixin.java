...
/**
 * Bridges the role-override refresh to the lightning role-rotation game mode:
 * normalizes the live draft state and re-broadcasts the rotation sync packet
 * when anything changed.
 */
@Mixin(value = SRERoleRotationGameMode.class, remap = false)
public abstract class SRERoleRotationGameModeRoleOverrideMixin implements RoleRotationOverrideAccess {
