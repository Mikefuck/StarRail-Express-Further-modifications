        ...
        TaskRegistry.register("habitrain_core", "sabotage_wiring", builder -> builder
            ...
            .onComplete((player, task) -> {
                if (player instanceof ServerPlayer serverPlayer) {
                    BlackoutTaskHelper.applyTimeImpact(serverPlayer.serverLevel(), com.habitrain.core.game.blackout.BlackoutExclusiveTasks.TASK_SABOTAGE_WIRING);
                    BlackoutTaskHelper.grantRewards(serverPlayer, com.habitrain.core.game.blackout.BlackoutExclusiveTasks.TASK_SABOTAGE_WIRING);
