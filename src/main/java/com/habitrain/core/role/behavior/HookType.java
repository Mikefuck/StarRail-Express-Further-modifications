...
public enum HookType {
    ...
    LIFECYCLE_ON_GAME_TRUE_START(Category.LIFECYCLE),
    LIFECYCLE_ON_GAME_END(Category.LIFECYCLE),
    LIFECYCLE_ON_ROLES_CONFIRM(Category.LIFECYCLE),
    ...
    COMBAT_ALLOW_KILL_BY_KILLER(Category.COMBAT),
    ...
    INTERACTION_USE_ENTITY(Category.INTERACTION),
    INTERACTION_USE_BLOCK(Category.INTERACTION),
    INTERACTION_ATTACK_ENTITY(Category.INTERACTION),
    INTERACTION_ATTACK_BLOCK(Category.INTERACTION),
    INTERACTION_BLOCK_BREAK(Category.INTERACTION),
