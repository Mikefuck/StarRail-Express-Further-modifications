 ...
 * client-extension registry. A nullable definition hash means the snapshot has
 * not arrived yet and the server must keep gameplay actions blocked.
 *
 ...
 *                                 {@code null} while the handshake is incomplete
...
public record ClientManifest(
    ...
    /** Convenience constructor for an incomplete, fail-closed handshake report. */
