...
public final class SceneOrbitMath {
    ...
    public static double resolveRadius(SceneProfile profile) {
        ...
        double[] p0 = profile.displayOriginRaw();
        double dx = p0[0] - c[0];
        double dy = p0[1] - c[1];
        double dz = p0[2] - c[2];
    ...
    public static double[] resolveOrbitCenter(SceneProfile profile) {
        ...
        if (orbit.getCenterMode() == SceneOrbitCenterMode.MODEL_CENTER) {
            return calculateModelCenter(profile.getSourceBounds(), profile.displayOriginRaw(),
                    profile.pivotLocalRaw(), profile.getRotationDegrees());
        } else {
            return orbit.centerWorldRaw();
        }
    }
    ...
    public static double resolveStartAngle(SceneProfile profile) {
        ...
        if (orbit.getCenterMode() == SceneOrbitCenterMode.MODEL_CENTER) {
            ...
            return deriveStartAngle(center, profile.displayOriginRaw(), orbit.getAxis());
        }
